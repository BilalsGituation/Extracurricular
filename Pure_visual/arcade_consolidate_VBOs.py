    ...
    def setup(self):
        ...
        for x in range(0, SCREEN_WIDTH, SQUARE_SPACING):
            for y in range(0, SCREEN_HEIGHT, SQUARE_SPACING):
                ...
                # gradients.
                for i in range(4):
                    colour_list.append(arcade.color.DARK_BLUE)
                    colour_list.append(arcade.color.RED)
                    colour_list.append(arcade.color.YELLOW)
                    colour_list.append(arcade.color.SKY_BLUE)
